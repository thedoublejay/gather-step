...
Point Gather Step at the directory that contains your repositories. Let `init` write the config, build the first index, generate assistant-facing context files, and register Claude MCP settings:
