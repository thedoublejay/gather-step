...
pub fn node_kind_label(kind: NodeKind) -> &'static str {
    match kind {
        ...
        NodeKind::AgentGraph => "agent_graph",
        NodeKind::Prompt => "prompt",
        NodeKind::AiContract => "ai_contract",
        NodeKind::VectorIndex => "vector_index",
        NodeKind::McpServer => "mcp_server",
        NodeKind::McpTool => "mcp_tool",
        NodeKind::LlmModel => "llm_model",
        _ => "unknown",
    }
}
...
pub fn edge_kind_label(kind: EdgeKind) -> &'static str {
    match kind {
        ...
        EdgeKind::SpawnsSubagent => "spawns_subagent",
        EdgeKind::BindsTool => "binds_tool",
        EdgeKind::InvokesLlm => "invokes_llm",
        EdgeKind::ProducesAiContract => "produces_ai_contract",
        EdgeKind::UsesPrompt => "uses_prompt",
        EdgeKind::FetchesPromptFrom => "fetches_prompt_from",
        EdgeKind::RetrievesFrom => "retrieves_from",
        EdgeKind::Embeds => "embeds",
        EdgeKind::IndexesVector => "indexes_vector",
        EdgeKind::CallsMcpTool => "calls_mcp_tool",
        EdgeKind::ExposesMcpTool => "exposes_mcp_tool",
        _ => "unknown",
    }
}
